...
//                         {bus.Route && (
//                           <>
//                             <p>{pickup} - {dropoff}</p> {/* Display user search from and to */}
//                             <p>{bus.busType}</p>
//                           </>
//                         )}
//                       </p>
...
//     navigate('/bus-details', { state: { busId: bus.busId, from: pickup, to: dropoff, fare: bus.fare } });
//   };
...
//                           <>
//                             {isSearchPerformed ? (
//                               <p>{pickup} - {dropoff}</p> // Display user search from and to when search performed
//                             ) : (
//                               <p>{bus.Route.from} - {bus.Route.to}</p> // Display normal route from and to
//                             )}
//                             <p>{bus.busType}</p>
//                           </>
//                         )}
