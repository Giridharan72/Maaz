...
//                       <p className="card-text mt-2"><strong>Facilities:</strong> {bus.facilities.join(', ')}</p>
//                     </div>
//                   </div>
//                 </div>
//               </div>
              ...
              <div key={bus.busId} className="col-md-12 mb-4">
                <div className="card h-100 d-flex flex-column">
                  <div className="card-body">
                    ...
                    <div className="mt-auto">
                      <p className="card-text mt-2"><strong>Facilities:</strong> {bus.Facility.facilities.join(', ')}</p>
                    </div>
                  </div>
                </div>
              </div>
